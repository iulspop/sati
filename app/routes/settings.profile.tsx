...
import { schema, UserProfileComponent } from '~/features/user-profile/user-profile-component'
...
const mutation = makeDomainFunction(
  schema,
  environmentSchema
)(async (values, { userId }) => await updateUserProfileInDatabaseById({ id: userId, userProfile: values }))
