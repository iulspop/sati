...
const CheckBox = forwardRef<HTMLInputElement, JSX.IntrinsicElements['input']>(function CheckBox(
  { type = 'checkbox', ...props },
  ref
) {
  return (
...
const CheckBoxWrapper = (props: JSX.IntrinsicElements['div']) => <div className="flex h-5 items-center" {...props} />
...
const Field = (props: JSX.IntrinsicElements['div']) => <div className="sm:col-span-6" {...props} />
...
const Label = (props: JSX.IntrinsicElements['label']) => (
  <label className="block text-sm font-medium text-gray-700 dark:text-gray-400" {...props} />
)

export const Radio = forwardRef<HTMLInputElement, JSX.IntrinsicElements['input']>(function Radio(
  { type = 'radio', ...props },
  ref
) {
  return (
    <input className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" ref={ref} type={type} {...props} />
  )
})

const Select = forwardRef<HTMLSelectElement, JSX.IntrinsicElements['select']>(function Select(props, ref) {
  return (
    <select
      autoComplete={mapIdToAutoComplete(props.name)}
...
const TextArea = forwardRef<HTMLTextAreaElement, JSX.IntrinsicElements['textarea']>(function TextArea(props, ref) {
  return (
    <textarea
...
export const Form = <Schema extends SomeZodObject>(props: FormProps<Schema>) => (
  <RemixForm<Schema>
